...
namespace _2014140210
{
    public class Venta
    {
        ...
        public Venta(int id, Administrativo administratativo, Cliente cliente, TipoComprobante tipoComprobante, Servicio servicio, TipoPago tipoPago, String fechaVenta, TipoViaje tipoViaje)
        {
            this.id = id;
