...
namespace _2014140210
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Administrativo admin1 = new Administrativo( "Diego", "Zarate", "diegozarate@mail.com", 850, "06:00", "15:00");
            Administrativo admin2 = new Administrativo( "luis", "Quispe", "uisquispe@hotmail.com", 1000,  "04:00", "16:00");
            Tripulacion tripul1 = new Tripulacion( "karla", "Palomino", "Karlapalomino@hotmail.com", 1200, azafata, 5);
            Tripulacion tripul2 = new Tripulacion( "sofia", "sosa", "sosass@hotmail.com", 1100, azafata, 4);
            Tripulacion tripul3 = new Tripulacion( "william", "Acosta", "williacosta@hotmail.com", 1500, chofer, 6);
            Tripulacion tripul4 = new Tripulacion( "luis", "benitez", "lbenitez@hotmail.com", 1500, chofer, 6);
            // Buses (1 Bus)
            Bus bus1 = new Bus("XYZ201", "ford", "Rojo", 55000);
            bus1.AgregarTripulante(tripul1);
            bus1.AgregarTripulante(tripul3);
            
            // Clientes (5 Clientes)
            Cliente cliente1 = new Cliente(25638855, "gabriela", "kolevic", 19, 'f', "gkolev@hotmail.com", 970555854);
            Cliente cliente2 = new Cliente(15487887, "daniel", "bendezu", 21, 'm', "danielbendezu@hotmail.com", 987454412);
            Cliente cliente3 = new Cliente(14747496, "Marcos", "Martinez", 18, 'm', "marcosM@hotmail.com", 987654112);
            Cliente cliente4 = new Cliente(14587444, "Mia", "Khalifa", 15, 'f', "KhaliM@hotmail.com", 951115330);
            Cliente cliente5 = new Cliente(14855499, "Maya", "Revilla", 20, 'f', "MayaRe@hotmail.com", 145788999);
            ...
            Venta pasaje3 = new Venta(3, admin1, cliente3, boleta, new Transporte(3, bus1, normal, cliente3, limaDestino, "22/03/17", "23/03/17"), efectivo, "21/03/17",vip);
            Venta encomienda1 = new Venta(4, admin2, cliente2, factura, new Encomienda(1, limaDestino, bus1, "Play Station 4", "22/03/17", "23/03/17"), tarjeta, "20/03/17",normal);
            Venta encomienda2 = new Venta(5, admin2, cliente1, factura, new Encomienda(2, limaDestino, bus1, "Una caja de zapatos", "22/03/17", "23/03/17"), tarjeta, "21/03/17",vip);
